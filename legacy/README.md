...
- `main` 只有一個起始提交，舊歷史存在 tag 裡
  - `archive/pre-cleanup`：整理前的完整歷史
  - `archive/v1-v4-evidence`：`2769f876`
  - `archive/docs-index-d613b75`：`d613b75`
  - 取得：`git fetch origin tag archive/pre-cleanup`
